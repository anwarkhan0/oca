          ...
          <div class="row">
            ...
            <!-- <div class="col-xl-2 col-md-4 col-6">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><strong class="text-uppercase">New Doctors</strong><span>Last 7 days</span>
            ...
            <div class="col-xl-2 col-md-4 col-6">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><strong class="text-uppercase">Total Patients</strong>
                  <div class="count-number"><?= $total_patients ?></div>
                </div>
              </div>
            </div>
            <!-- Count item widget-->
            <!-- <div class="col-xl-2 col-md-4 col-6">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><strong class="text-uppercase">Appointments</strong><span>Last 7 days</span>
            ...
            <div class="col-xl-2 col-md-4 col-6">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><strong class="text-uppercase">Total Doctors</strong>
                  <div class="count-number"><?= $total_docs ?></div>
                </div>
              </div>
            </div>
            <!-- Count item widget-->
            <div class="col-xl-2 col-md-4 col-6">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><strong class="text-uppercase">Total Appointments Booked</strong>
                  <div class="count-number"><?= $total_appointments ?></div>
                </div>
              </div>
            </div>
            <!-- Count item widget-->
